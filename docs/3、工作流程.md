...
## 1. 关键流程实现 (Key Process Implementation)

### 1.1 文档树构建算法（DocumentTree Construction）
...
### 1.3 Markdown 渲染管道（Markdown Rendering Pipeline）
...
### 1.4 HTTP 服务调度与状态管理（HTTP Service Orchestration）
